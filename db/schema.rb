...
ActiveRecord::Schema.define(version: 20150111140129) do
  ...
  add_index "countries", ["name"], name: "name", length: {"name"=>255}, using: :btree
  ...
  create_table "user_views_monthlies", force: true do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
  end
