		...
		function widget($args, $instance) {
			...
			echo $before_widget . $before_title . $title . $after_title;
				...
				if($sc_options["get_twitter"]=='1'){
					?>
					<li class="scItems"><a href="http://www.twitter.com/<?php echo $sc_options['twitter_token'] ?>"><img src="<?php echo $img_url."large/".$icon_set."/twitter.png" ?>" /></a><div ><span><?php echo twitterCounts('socialappshq') ?> Followers</span><br /><a href="http://www.twitter.com/<?php echo $sc_options['twitter_token'] ?>">Follow us on Twitter</a></div></li>
					<?php
				}
			...
			<?php
				...
				if($sc_options["get_twitter"]=='1'){
					?>
					<li class="scItems"><a href="http://www.twitter.com/<?php echo $sc_options['twitter_token'] ?>"><img src="<?php echo $img_url."large/".$icon_set."/twitter.png" ?>" /></a><br /><span>Followers</span><br /><?php echo twitterCounts('socialappshq') ?></li>
					<?php
				}
